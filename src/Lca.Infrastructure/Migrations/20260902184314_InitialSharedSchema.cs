        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplaySubCategory = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RetailRate = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    WholesaleRate = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DealerRate = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ...
                    Image5 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Image6 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Image7 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Image8 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Image9 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "9f3a6866-4605-43c6-9174-9a37c63cd361", "3a0523aa-2c72-4a2c-bf5e-3f68e880ce72", "PlatformAdmin", "PLATFORMADMIN" });

            migrationBuilder.InsertData(
                schema: "dbo",
                table: "Tenants",
                columns: new[] { "Id", "CreatedAtUtc", "Name", "Slug", "Status", "UpdatedAtUtc" },
                values: new object[] { 1L, new DateTime(2026, 9, 3, 0, 0, 0, 0, DateTimeKind.Utc), "Laxmi Ceramic", "lca", "Active", new DateTime(2026, 9, 3, 0, 0, 0, 0, DateTimeKind.Utc) });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_TenantId_ItemCode",
                schema: "dbo",
                table: "Products",
